...
export const dummyPosts: BlogPost[] = [
  {
    ...
    title: {
      rendered: 'Next.js 15の新機能を徹底解説：App Routerとサーバーコンポーネントの進化',
      protected: false,
    },
    content: {
...
<p>これらの新機能により、Next.jsアプリケーションの開発体験が大幅に向上しています。</p>`,
    ...
    excerpt: {
      rendered:
        '<p>Next.js 15の新機能について詳しく解説します。App Router、Turbopack、Server Actionsの改善点を中心に、実際のコード例を交えて説明します。</p>',
      protected: false,
    },
    author: 1,
    featured_media: 101,
    ...
    _links: {
      ...
      'predecessor-version': [
        { id: 2, href: 'https://example.com/wp-json/wp/v2/posts/1/revisions/2' },
      ],
      'wp:featuredmedia': [
        { embeddable: true, href: 'https://example.com/wp-json/wp/v2/media/101' },
      ],
  ...
  },
  {
    ...
    title: {
      rendered: 'TypeScript開発者が知っておくべき2024年のベストプラクティス',
      protected: false,
    },
    content: {
...
<p>これらのベストプラクティスを採用することで、より堅牢で保守性の高いTypeScriptコードを書くことができます。</p>`,
    ...
    excerpt: {
      rendered:
        '<p>2024年のTypeScript開発で採用すべきベストプラクティスを紹介。厳密な型定義、ユーティリティ型、条件付き型の効果的な使い方を解説します。</p>',
      protected: false,
    },
    author: 1,
    featured_media: 102,
    ...
    _links: {
      ...
      'predecessor-version': [
        { id: 3, href: 'https://example.com/wp-json/wp/v2/posts/2/revisions/3' },
      ],
      'wp:featuredmedia': [
        { embeddable: true, href: 'https://example.com/wp-json/wp/v2/media/102' },
      ],
